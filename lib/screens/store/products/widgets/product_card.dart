                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: product.isFavorite
                                  ? Colors.white.withOpacity(0.7)//kPrimaryColor.withOpacity(0.6)
                                  : Colors.black.withOpacity(0.4),//kSecondaryColor.withOpacity(0.6),
                              // shape: BoxShape.circle,
                            ),
                            child: SvgPicture.asset(
                              "assets/icons/Heart Icon_2.svg",
                              color: product.isFavorite
                                  ? Colors.black//Colors.white //Color(0xFFFF4848)
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        ...
                        child:  Container(
                            ...
                            decoration: BoxDecoration(
                              color: product.isFavorite
                                  ? Color(0x33fff3).withOpacity(0.3)//kPrimaryColor.withOpacity(0.6)
                                  : Colors.black.withOpacity(0.4),//kSecondaryColor.withOpacity(0.6),
                              shape: BoxShape.circle,
                            ),child:SvgPicture.asset(
                              ...
                              // color:
                              //     Colors.blue, //"assets/icons/Chat bubble Icon.svg",
                            ),),
                      ),
                    );
                  }),
